...
-(void)_selectShareAction:(UITapGestureRecognizer *)tap{
    ...
    [share lotteryShareActionWithURL:self.model.url AndPitcurePath:self.model.picturePath AndShareTitle:self.model.shareTitle AndShareContent:self.model.content WithLastType:row];
   
}

#pragma mark - 显示分享状态信息
